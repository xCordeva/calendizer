...
export default function Navbar() {
  ...
  const notificationPopupClicked = useSelector((state) => state.NotificationPopup.value)
      ...
      <div className='navbar'>
        ...
        {user ? (
          <div className="notif-user">
            <FontAwesomeIcon icon={faBell}  onClick={()=>{dispatch(openNotificationPopup(true))}}/>
            <FontAwesomeIcon icon={faUser} onClick={()=>{dispatch(openUserPopup(true))}}/>
          </div>
        ) : (
